...
class BasicAction(AbstractBaseAction):
    ...
    def __init__(self, action_name:str, unlocked:bool=False, value:float=None) -> None:
        """
    ...
    def __eq__(self, other_action) -> bool:
        return isinstance(other_action,BasicAction) and self.action_name==other_action.action_name and self.unlocked==other_action.unlocked and self.value==other_action.value
