...
SUM_UNLOCKED_VALUE = sum(x.value for x in SETUP_LIST_ACTIONS_TO_UNLOCK_WITH_PRE_UNLOCK)
...
class TestBasicAgentWithCumValue(TestCase):
    def setUp(self):
        self.agent_basic = BasicAgentWithCumValue(
            name=SETUP_AGENT_NAME,
            potential_actions=SETUP_INITIAL_LIST_ACTIONS,
            pre_unlock_actions_names=None,
        )
        self.agent_basic_pre_unlock = BasicAgentWithCumValue(
    ...
    def test_env_creation(self):
        ...
        assert isinstance(self.agent_basic, BasicAgentWithCumValue)
        assert isinstance(self.agent_basic_pre_unlock, AbstractBaseAgent)
        assert isinstance(self.agent_basic_pre_unlock, BasicAgentWithCumValue)
        ...
        assert self.agent_basic_pre_unlock.get_current_reward() == SUM_UNLOCKED_VALUE
    ...
    def test_str(self):
        ...
        assert str(SUM_UNLOCKED_VALUE) in str(self.agent_basic_pre_unlock)
